  ...
  return (
    <div className="max-w-xl mx-auto bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-lg mt-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block mb-1 text-sm font-medium">
            Upload Aadhaar XML <span className="text-gray-400">(optional)</span>
          </label>
          <input
            type="file"
            name="xmlFile"
        ...
        <div>
          <label className="block mb-1 text-sm font-medium">
            XML Share Code <span className="text-gray-400">(optional)</span>
          </label>
          <input
            type="password"
            name="shareCode"
        ...
        <div>
          <label className="block mb-1 text-sm font-medium">
            Upload Selfie <span className="text-gray-400">(optional)</span>
          </label>
          <input
            type="file"
            name="selfie"
